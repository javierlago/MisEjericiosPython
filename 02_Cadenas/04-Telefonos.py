...
# (por ejemplo +34-913724710-56). Escribir un programa que pregunte
# por un número de teléfono con este formato y muestre
# por pantalla el número de teléfono sin el prefijo y la extensión.

numero_telf = input("Indique el numero de telefono")
numero_corto = numero_telf.split("-")[1]
print(numero_corto)